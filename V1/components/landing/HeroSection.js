    ...
    <section className="min-h-[92vh] px-6 sm:px-8 lg:px-12 pt-28 pb-16 sm:pt-28 md:pt-32 md:pb-20 lg:pt-36 lg:pb-24 flex items-center overflow-hidden" id="hero">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6">
          <Reveal delay={0.12}>
              <motion.div
                className="relative h-[340px] sm:h-[440px] w-full transform-gpu will-change-transform px-3 sm:px-4"
                style={parallaxStyle}
              >
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-brand-darker via-brand-dark to-brand-darker border border-white/5 shadow-glow-lg overflow-hidden">
                  ...
                  <div className="relative h-full w-full flex items-center justify-center px-3 sm:px-6">
                    <motion.div
                      className="relative w-full max-w-[240px] sm:max-w-[340px] md:max-w-[360px] aspect-square"
                  ...
                  <div className="absolute bottom-4 left-0 right-0 text-center text-[10px] sm:text-xs text-brand-light/70 px-4">
